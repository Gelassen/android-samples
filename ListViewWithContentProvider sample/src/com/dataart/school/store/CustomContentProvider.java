package com.dataart.school.store;
...
public class CustomContentProvider extends ContentProvider {
    ...
    public static final Uri STORES_URI = Uri.parse("content://" 
            + AUTHORITY + "/" + Schema.Stores.TABLE_NAME);
    ...
    @Override
    public Cursor query(Uri uri, String[] proejction, String selection, 
        ...
        Cursor cursor = builder.query(db.getReadableDatabase(), proejction, selection, 
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long itemId =  db.getWritableDatabase().insertWithOnConflict(table, null, values, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private static final String CREATE_STORES = "CREATE TABLE " 
            + Schema.Stores.TABLE_NAME + " (" + Schema.Stores._ID 
            + " INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, "
            + Schema.Stores.ID + " INTEGER, "
            + Schema.Stores.STORE_NAME + " TEXT, "
            + Schema.Stores.ADDRESS + " TEXT, "
            + Schema.Stores.PHONE + " TEXT, "
            + Schema.Stores.LATITUDE + " TEXT, "
            + Schema.Stores.LONGITUDE + " TEXT);";
